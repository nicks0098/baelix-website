...
CREATE INDEX IF NOT EXISTS idx_download_signups_source_created_at
ON download_signups(source_hash, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_prompt_telemetry_created_at
ON prompt_telemetry(created_at DESC);

CREATE INDEX IF NOT EXISTS idx_prompt_telemetry_installation_created_at
ON prompt_telemetry(installation_id, created_at DESC);
